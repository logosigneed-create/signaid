    ...
    */
    ...
    const mobileTools = [
        ...
        { id: 'image', icon: 'fa-image', label: 'Image', action: handleImportButtonClick },
        {
            ...
            className: `${aiResult ? 'animate-bounce-ia' : ''} !bg-orange-600 !text-white !scale-110 shadow-lg`
        },
                                        ...
                                        {([1, 2, 3] as const).map(slot => {
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`flex-1 h-8 rounded-xl border-2 text-xs font-black transition-all flex items-center justify-center gap-1.5 ${
                                                        activeLogoSlot === slot
