...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white text-zinc-900 font-sans selection:bg-brand-orange/20">
            ...
            <main className={`flex-grow ${bannerSettings.enabled ? 'pt-8 md:pt-12' : 'pt-0'}`}>

                {/* MANIFESTO HERO */}
                <section id="hero" className="px-6 pb-24 md:pb-32 border-b border-gray-100">
                        ...
                        <div className="flex flex-col md:flex-row gap-12 md:items-end mb-16">
                            <div className="md:w-3/4">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link to="/creation?openLogoOptions=true&checkDraft=true" className="inline-flex px-10 py-4 bg-zinc-900 text-white font-bold rounded-full hover:bg-black transition-all items-center gap-3 group shadow-xl shadow-orange-500/10">
                                        Créer mon projet
                ...
                <section id="guide" className="py-24 bg-white relative">
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="mb-20 text-center md:text-left">
                            <span className="text-orange-600 font-black uppercase tracking-widest text-sm mb-4 block">ÉCOSYSTÈME COMPLET</span>
                            <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-zinc-900 mb-6 uppercase">
                                COMMENT ÇA MARCHE ?
                            </h2>
                            <div className="w-24 h-2 bg-orange-500 mb-8 md:mx-0 mx-auto"></div>
                        </div>
