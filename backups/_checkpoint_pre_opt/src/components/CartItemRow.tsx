                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="text-right flex flex-col items-end gap-1">
                        <div className="flex flex-col items-end">
                            ...
                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Prix Unitaire TTC</span>
                        </div>

                        <div className="bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-100 flex flex-col items-end gap-0.5 mt-1">
