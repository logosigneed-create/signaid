...
import { DraggableElement } from '../src/components/DraggableElement';
...
import { uploadImageBlob } from '../src/services/storageService';
...
import { SignPongRewardModal } from '../src/components/SignPongRewardModal';
import { logAnalyticsEvent, AnalyticsEvents } from '../src/services/analyticsService';
    ...
    const handleAddToProfile = async () => {
        ...
        try {
            ...
            await postService.createPost({
                ...
                user: postUser,
                imageUrl: aiResult,
                caption: postCaption || `Ma création signeedclub - ${product.name}`,
    ...
    return (
        <div className="flex flex-col h-full w-full max-w-7xl mx-auto relative pb-24 bg-white overflow-x-hidden scrollbar-hide">
            ...
            <div className="flex-1 relative flex flex-col items-center justify-start md:justify-center p-4 bg-white overflow-y-auto overflow-x-hidden w-full scrollbar-hide">
                ...
                <div className="relative w-full max-w-[400px] aspect-[3/4] flex items-center justify-center z-10 mt-[-10vh] lg:mt-[-5vh]">
                    ...
                    >
                        <div className="w-20 h-28 rounded-2xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.1)] border border-gray-100 bg-white p-1">
                            <img
                                src={getProxiedUrl(isBack ? product.backImages[colors[prevIndex]] : product.images[colors[prevIndex]])}
                    ...
                    <div
                        ...
                        className="relative w-full h-full bg-white select-none p-6"
                    ...
                    >
                        <div className="w-20 h-28 rounded-2xl overflow-hidden shadow-[0_10px_30_rgba(0,0,0,0.1)] border border-gray-100 bg-white p-1">
                            <img
                                src={getProxiedUrl(isBack ? product.backImages[colors[nextIndex]] : product.images[colors[nextIndex]])}
                                className="w-full h-full object-contain opacity-80 group-hover:opacity-100 transition-opacity"
                                alt="Suivant"
                            />
                        </div>
                                                ...
                                                onClick={async () => {
                                                    ...
                                                    if (!currentRemoved && url) {
                                                        ...
                                                        try {
                                                            ...
                                                            alert("Erreur lors du détourage. Veuillez réessayer.");
                                                        } finally {
                ...
                <div className="lg:col-span-3 space-y-6 order-2 lg:order-3 flex flex-col h-full relative z-10">
                    ...
                    <div className="relative group mb-4">
                        ...
                        >
                            ...
                            <span>{isCapturing ? "Capture..." : "Ajouter au Panier"}</span>
                        </button>
                    </div>
                </div>
                                    ...
                                    <>
                                                            ...
                                                            {allStyles.map((item, idx) => {
                                                                ...
                                                                return (
                                                                    <button
                                                                        ...
                                                                        onClick={() => { setSelectedStylePrompt(item.style.prompt); setCustomStylePrompt(item.style.prompt); setActiveStyleCategory(item.category as StyleCategory); }}
                                        ...
                                        {capturedImage && (
                                            <div className="space-y-4">
                                                {aiGenerating ? (
                                                    <div className="w-full aspect-[3/4] max-w-sm mx-auto rounded-xl overflow-hidden shadow-2xl relative z-0 isolate border-4 border-gray-900 bg-gray-900 md:max-h-[80vh] short-screen-h">
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="max-w-sm mx-auto space-y-3">
                                                            ...
                                                            <button
                                                                onClick={() => { setCapturedImage(null); setAiResult(null); setIsCameraOpen(true); }}
