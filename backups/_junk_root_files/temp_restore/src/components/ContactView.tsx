                ...
                <div className="space-y-8 mt-4">
                    <div className="flex items-start gap-4 p-6 bg-orange-50 rounded-2xl border border-orange-100">
                        ...
                        <div>
                            ...
                            <a href="mailto:info@signeedclub.com" className="text-orange-600 font-bold hover:underline">
                                info@signeedclub.com
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-6 bg-zinc-50 rounded-2xl border border-gray-200">
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/32479359439" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-green-600 font-bold hover:underline">
