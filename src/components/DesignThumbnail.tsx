...
export const DesignThumbnail: React.FC<DesignThumbnailProps> = ({ item, product, side, className, productsMapping }) => {
    ...
    const baseImage = getProxiedUrl(isBack ? product.backImages[item.color] : product.images[item.color], { width: 400 });
            ...
            >
                <div className="relative w-full h-full p-[6.5%]">
                    ...
                    {logoUrl && (
                        ...
                        >
                            <img
                                src={logoUrl.startsWith('data:') ? logoUrl : getProxiedUrl(logoUrl, { width: 200 })}
                                alt="Logo"
