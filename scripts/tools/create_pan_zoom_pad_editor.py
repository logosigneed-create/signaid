...
<head>
  <meta charset="UTF-8">
  <title>Éditeur Vectoriel - Pan à la Souris, Zoom & Pad 2D</title>
  <style>
...
<body>
  ...
  <header>
    <h1>🔍 Éditeur Vectoriel - Déplacement Image à la Souris & Pad 2D (Axe X/Y)</h1>
    <div class="toolbar">
    ...
    <div class="sidebar">
      ...
      <div class="pad-container">
        <div style="font-size: 0.8rem; font-weight: 700; color: #38bdf8; width: 100%; display: flex; justify-content: space-between;">
          <span>🕹️ Pad 2D Multidirectionnel (Axe X / Y)</span>
  ...
  <script>
    ...
    // Mouse Canvas Panning when NO point is clicked
    ...
    function downloadSVG() {{
      ...
      a.download = 'logo_pad2d_mousepan.svg';
      a.click();
    }}
...
print(f"Mouse panning, zoom and 2D pad vector editor saved to {output_path}")
