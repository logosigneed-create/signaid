...
<head>
  <meta charset="UTF-8">
  <title>Éditeur Vectoriel - Points d'Ancrage Transparents</title>
  <style>
    * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Inter, sans-serif; }}
    ...
    .canvas-container {{ flex: 1; position: relative; background: #000; display: flex; justify-content: center; align-items: center; user-select: none; overflow: hidden; cursor: grab; }}
    ...
    textarea {{ width: 100%; height: 90px; background: #090d16; color: #38bdf8; border: 1px solid #334155; padding: 8px; font-family: monospace; font-size: 0.72rem; border-radius: 6px; resize: none; }}

    /* TRANSPARENT HOLLOW RING ANCHOR NODES (Laisse voir l'image derrière !) */
    ...
    .draft-path {{ fill: rgba(255, 255, 255, 0.80); stroke: #38bdf8; stroke-width: 1.5px; }}
...
<body>
  ...
  <header>
    <h1>🎯 Éditeur Vectoriel - Points d'Ancrage Transparents (Vue Image 100%)</h1>
    <div class="toolbar">
  ...
  <div class="main">
    ...
    <div class="sidebar">
      ...
      <div>
        <div class="section-title">Modèle de Fond (Transparence)</div>
  ...
  <script>
    ...
    // 2D Trackpad Pad (Exclusively Controls Angle & Arch Curve)
    ...
    // TRANSPARENT HOLLOW RING ANCHOR NODES (Permet de voir les pixels de l'image derrière !)
    ...
    function downloadSVG() {{
      ...
      a.download = 'logo_points_transparents.svg';
      a.click();
    }}
...
print(f"Transparent anchors vector editor saved to {output_path}")
