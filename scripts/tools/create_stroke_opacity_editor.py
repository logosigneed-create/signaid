...
<head>
  <meta charset="UTF-8">
  <title>Éditeur Vectoriel - Contrôle d'Opacité des Traits Vectoriels</title>
  <style>
    * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Inter, sans-serif; }}
    ...
    textarea {{ width: 100%; height: 90px; background: #090d16; color: #10b981; border: 1px solid #10b981; padding: 8px; font-family: monospace; font-size: 0.72rem; border-radius: 6px; resize: none; }}
...
<body>
  ...
  <header>
    <h1>🎨 Éditeur Vectoriel - Contrôle d'Opacité des Traits Vectoriels</h1>
    <div class="toolbar">
  ...
  <div class="main">
    ...
    <div class="sidebar">
      ...
      <!-- Réglage d'Opacité des Traits Vectoriels & du Brouillon -->
      <div>
      ...
      <div style="flex: 1; display: flex; flex-direction: column;">
        <div class="section-title" style="color: #10b981;">Code SVG Transparent</div>
  ...
  <script>
    ...
    function downloadSVG() {{
      ...
      a.download = 'logo_opacite_traits.svg';
      a.click();
    }}
...
print(f"Vector stroke opacity editor saved to {output_path}")
