...
<head>
  <meta charset="UTF-8">
  <title>Éditeur Vectoriel Minimaliste - Gris & Orange</title>
  <style>
    * {{ box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }}
    ...
    .btn {{ background: #262930; color: #e5e7eb; border: 1px solid #374151; padding: 6px 12px; border-radius: 5px; cursor: pointer; font-weight: 500; font-size: 0.8rem; transition: all 0.15s ease; }}
    ...
    #bg-img {{ position: absolute; top:0; left:0; width: 581px; height: 481px; opacity: 0.5; pointer-events: none; filter: grayscale(100%) contrast(120%); }}
...
<body>
  ...
  <script>
    ...
    function downloadSVG() {{
      ...
      a.download = 'logo_vectorise_minimaliste.svg';
      a.click();
    }}
...
print(f"Minimalist gray and orange vector editor saved to {output_path}")
